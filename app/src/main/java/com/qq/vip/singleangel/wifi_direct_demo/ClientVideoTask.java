...
public class ClientVideoTask extends AsyncTask<Void, Void, String> {
    ...
    public ClientVideoTask(Context context, View statusText, DeviceDetailFragment deviceDetailFragment){
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            serverSocket = new ServerSocket(26655);
